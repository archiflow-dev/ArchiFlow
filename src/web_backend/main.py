...
from .routes import sessions, agents, artifacts, workflow, messages, agent_execution, workspace, comments
...
app.add_middleware(
    ...
    allow_methods=["*"],
    allow_headers=["*"],
    expose_headers=["*"],  # Expose all headers including ETag for caching
)
