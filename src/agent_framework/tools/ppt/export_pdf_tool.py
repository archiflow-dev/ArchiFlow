...
class ExportPDFTool(BaseTool):
    ...
    parameters: Dict[str, Any] = {
        ...
        "properties": {
            ...
            "output_dir": {
                "type": "string",
                "description": "Output directory for the PDF file (default: data/sessions/{session_id}/ppt_exports)"
            },
            "slide_pattern": {
                "type": "string",
    ...
    async def execute(
        ...
        **kwargs
        ...
        Args:
            ...
            output_dir: Output directory for the PDF file (default: data/sessions/{session_id}/ppt_exports)
